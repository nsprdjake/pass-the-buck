    ...
    <main className="felt-saloon relative min-h-[100dvh] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-md px-5 pt-7 pb-10">
          ...
          {TABS.map((key) => (
            <button
              ...
              style={{
                ...
                borderColor:
                  active === key ? "#7a5a18" : "rgba(201,154,51,0.4)",
                color: active === key ? "#2a1a0a" : "rgba(244,228,183,0.75)",
                textShadow:
                  active === key
        ...
        <div className="mb-3 text-center">
          ...
          <p
            className="text-[0.72rem] italic text-[#f4e4b7]/55"
            style={FELL}
          >
            {meta.subtitle}
          </p>
        ...
        {/* List */}
        <section
          className="rounded-[16px] border-[1.5px] border-[#c99a33]/35 p-3"
          style={{
            background:
        ...
        >
          {error ? (
            ...
            <div
              className="py-6 text-center text-[0.85rem] italic text-[#f4e4b7]/50"
              style={FELL}
            >
              Tallying the votes…
            </div>
            ...
            <ol className="space-y-1.5">
              {rows.map((r, i) => (
                <li
                  key={r.user_id}
                  className="flex items-center gap-3 rounded-[10px] border-[1.5px] border-[#c99a33]/25 px-3 py-2"
                  style={{
                    background:
                      i < 3
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div
                      className="truncate text-[0.92rem] font-bold text-[#f4e4b7]"
                      style={RYE}
                    >
                  ...
                  >
                    ...
                    <div
                      className="mt-0.5 text-[0.55rem] uppercase text-[#f4e4b7]/55"
        ...
        <p
          className="mt-5 text-center text-[0.72rem] italic text-[#f4e4b7]/45"
          style={FELL}
        >
