...
function AuthScreen() {
  ...
  const submitDisabled =
    busy || !email.trim() || password.length < (mode === "signup" ? 6 : 1);
  ...
  return (
    <main className="felt-saloon relative min-h-[100dvh] overflow-hidden">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-3 text-left">
              ...
              <Field
                ...
                hint={mode === "signup" ? "Six characters or more." : undefined}
              >
                <input
                  id="auth-password"
                  type="password"
      ...
      <style jsx>{`
        ...
        :global(.brass-cta) {
          background: linear-gradient(180deg, #ffd989 0%, #d8a93b 48%, #a07a22 100%);
          box-shadow:
            0 1px 0 rgba(255, 240, 200, 0.85) inset,
        ...
        :global(.brass-cta:disabled) {
          ...
          box-shadow:
            0 1px 0 rgba(244, 228, 183, 0.06) inset,
