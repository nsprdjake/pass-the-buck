    ...
    <form onSubmit={handleJoin} className="space-y-4">
      <Panel>
        ...
        <input
          ...
          placeholder="ABC123"
          className="parchment-input w-full rounded-[10px] px-4 py-3 text-center text-[1.6rem] font-bold uppercase tracking-[0.45em] text-[#2a1a0a] placeholder-[#5c3b1e]/40 focus:outline-none"
          style={FELL}
        />
      </Panel>
    ...
    <main className="felt-saloon relative min-h-[100dvh] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-md px-5 pt-7 pb-8">
        ...
        <Suspense
          fallback={
            <div
              className="py-8 text-center font-bold text-[#f4e4b7]/65"
              style={FELL}
            >
              Loading…
            </div>
...
function Panel({ children }: { children: React.ReactNode }) {
  return (
    <section
      className="relative rounded-[16px] border-[1.5px] border-[#c99a33]/35 p-4"
      style={{
        background:
